...
namespace neutrino::assets {
	...
	class data_loader : public data_loader_base<Resource, AdditionalArg> {};
	...
	template<typename Resource, typename AdditionalArg>
	Resource data_loader_base <Resource, AdditionalArg>::load(std::string key, std::istream& is, const AdditionalArg& arg) const {
