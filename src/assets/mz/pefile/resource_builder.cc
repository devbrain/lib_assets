...
namespace assets::pefile {
	namespace detail {
		...
		// ------------------------------------------------------------------------
		void
		parse_resource_directory(uint32_t rs_rva, uint32_t offs, bsw::istream_wrapper_c& stream, int depth,
		                         resource_dir_builder_c& rdb) {
			if (depth > 1) {
		...
		// ------------------------------------------------------------------------
		void
		create_res_dir(uint32_t rs_rva, bsw::istream_wrapper_c& stream, const windows_pe_file& pefile,
		               resource_dir_builder_c& rdb) {
