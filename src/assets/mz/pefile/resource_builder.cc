...
namespace assets::pefile {
	namespace detail {
		class resource_dir_builder_c {
		 public:
			explicit resource_dir_builder_c (resource_dir_c& rd);
		...
		// ------------------------------------------------------------------------
		void
		parse_resource_directory (uint32_t rs_rva, uint32_t offs, bsw::istream_wrapper_c& stream, int depth, resource_dir_builder_c& rdb) {
			if (depth > 1) {
		...
		// ------------------------------------------------------------------------
		void
		create_res_dir (uint32_t rs_rva, bsw::istream_wrapper_c& stream, const file_c& pefile, resource_dir_builder_c& rdb) {
