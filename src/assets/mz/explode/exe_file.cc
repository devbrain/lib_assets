...
static const char* header_to_string(assets::mz::exe_file::header_t h)
{
    switch (h)
    {
        case assets::mz::exe_file::SIGNATURE:
            return "SIGNATURE";
        case assets::mz::exe_file::NUM_OF_BYTES_IN_LAST_PAGE:
            return "NUM_OF_BYTES_IN_LAST_PAGE";
        case assets::mz::exe_file::NUM_OF_PAGES:
            return "NUM_OF_PAGES";
        case assets::mz::exe_file::RELLOCATION_ENTRIES:
            return "RELLOCATION_ENTRIES";
        case assets::mz::exe_file::HEADER_SIZE_PARA:
            return "HEADER_SIZE_PARA";
        case assets::mz::exe_file::MIN_MEM_PARA:
            return "MIN_MEM_PARA";
        case assets::mz::exe_file::MAX_MEM_PARA:
            return "MAX_MEM_PARA";
        case assets::mz::exe_file::INITIAL_SS:
            return "INITIAL_SS";
        case assets::mz::exe_file::INITIAL_SP:
            return "INITIAL_SP";
        case assets::mz::exe_file::CHECKSUM:
            return "CHECKSUM";
        case assets::mz::exe_file::INITIAL_IP:
            return "INITIAL_IP";
        case assets::mz::exe_file::INITIAL_CS:
            return "INITIAL_CS";
        case assets::mz::exe_file::RELLOC_OFFSET:
            return "RELLOC_OFFSET";
        case assets::mz::exe_file::OVERLAY_NUM:
            return "OVERLAY_NUM";
        case assets::mz::exe_file::MAX_HEADER_VAL:
            return "<UNKNOWN>";
    }
    return "";
}
