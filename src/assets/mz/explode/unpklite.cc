...
namespace {
	...
	// ===================================================================
	void
	adjust_length_code_2000 (uint16_t& length_code, neutrino::assets::mz::bit_reader& f, bool uncompressed_region) {
		// 4627
		while (true) {
			bool handeled = true;

			switch (length_code) {
				case 4:length_code = 3;
					break;
				case 0x0a:length_code = 2;
					break;
				case 0x0b: {
					...
					break;
				case 0xc:length_code = 4;
					break;
				case 0xd:length_code = 5;
					break;
				case 0x1c:length_code = 6;
					break;
				case 0x1d:length_code = 7;
					break;
				case 0x1e:length_code = 8;
					break;
				case 0x1f:length_code = 9;
					break;
				default:length_code = static_cast <uint16_t> (f.bit () | (length_code << 1));
					handeled = false;
					break;
			}
			// loc_4748
	...
	// -------------------------------------------------------------------
	void
	adjust_length_code_n2000 (uint16_t& length_code, neutrino::assets::mz::bit_reader& f, bool uncompressed_region) {
		// 474e
		while (true) {
			bool handeled = true;
			switch (length_code) {
				case 6:length_code = 2;
					break;
				case 7:length_code = 3;
					break;
				case 8:length_code = 4;
					break;
				case 0x12:length_code = 5;
					break;
				case 0x13:length_code = 6;
					break;
				case 0x14:length_code = 7;
					break;
				case 0x2a:length_code = 8;
					break;
				case 0x2b:length_code = 9;
					break;
				case 0x2c:length_code = 0xa;
					break;
				case 0x5a:length_code = 0xb;
					break;
				case 0x5b:length_code = 0xc;
					break;
				case 0x5c: {
					...
					break;
				case 0xba:length_code = 0xd;
					break;
				case 0xbb:length_code = 0xe;
					break;
				case 0xbc:length_code = 0xf;
					break;
				case 0x17a:length_code = 0x10;
					break;
				case 0x17b:length_code = 0x11;
					break;
				case 0x17c:length_code = 0x12;
					break;
				case 0x2fa:length_code = 0x13;
					break;
				case 0x2fb:length_code = 0x14;
					break;
				case 0x2fc:length_code = 0x15;
					break;
				case 0x2fd:length_code = 0x16;
					break;
				case 0x2fe:length_code = 0x17;
					break;
				case 0x2ff:length_code = 0x18;
					break;
				default:length_code = static_cast <uint16_t> (f.bit () | (length_code << 1));
					handeled = false;
			} // end of switch
	...
	typedef void (* adjust_length_code_fn) (uint16_t& length_code,
											neutrino::assets::mz::bit_reader& f,
											bool uncompressed_region);

	uint16_t get_base_offset (neutrino::assets::mz::bit_reader& f) {
		// 4b05
		while (true) {
			uint16_t offs = f.bit ();
			if (offs == 1) {
	...
	void build_rellocs (uint16_t h_pklite_info,
						neutrino::assets::mz::struct_reader<uint32_t>& fr,
...
namespace neutrino::assets::mz {
	...
	unpklite::unpklite (input_exe_file& inp)
		...
		const auto pklite_method = static_cast <uint16_t> (m_h_pklite_info & 0x1000);
		m_extended = (pklite_method == 0);
		const auto pklite_compression_model = static_cast <uint16_t> (m_h_pklite_info & 0x2000);
	...
	void unpklite::unpack (output_exe_file& oexe) {
		...
		const auto relloc_bytes = static_cast <uint16_t> (oexe.rellocations ().size () * 4);

		auto par_size = static_cast <uint16_t> (relloc_bytes + 0x1FF);
		par_size &= 0xFE00;
